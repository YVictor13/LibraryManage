...
public class BorrowView extends JFrame {
	...
	public BorrowView() {
		...
		button.setBounds(394, 302, 77, 23);
		...
		button_2.setBounds(485, 302, 77, 23);
		...
		ReadIDTxt.setBounds(156, 304, 224, 21);
 ...
 */
	...
	private  void AddActionPerformed(ActionEvent etv) {
		...
		try {
			...
			if(bookstate.equals("1")&&isDelete.equals("1")) {
				...
				JOptionPane.showMessageDialog(null, "请输入正确的图书信息或本书已经被删除\n请重新选择一本图书，此图书已被借阅");
			}
		} catch (Exception e) {
